...
namespace UnityEditor.Experimental.Rendering.Universal
{
    ...
    internal class RenderObjectsPassFeatureEditor : PropertyDrawer
    {
        internal class Styles
        {
            ...
            public static GUIContent input = new GUIContent("Input", "Choose at which point this render pass is executed in the frame.");
            //Headers
        ...
        private void Init(SerializedProperty property)
        {
            ...
            m_Input = property.FindPropertyRelative("Input");
        ...
        public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.PropertyField(rect, m_Input, Styles.input);
            rect.y += Styles.defaultLineSpace;
